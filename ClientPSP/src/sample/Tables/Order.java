...
public class Order implements Serializable{
    ...
    public Order(Integer Id, Integer ClientId, Integer ProductId, Integer ProviderId, Integer ProductNumber, Integer Finalprice) {
        this.order_id = Id;
        ...
        this.order_finalprice = Finalprice;
